...
DEFAULT_FINAL_RESULTS_CSV = PART5_DIR / "agent_runs" / "crypto_company" / "results.csv"
DEFAULT_RUN_PREFIX = "crypto_company_parallel_eval"
DEFAULT_LIVE_LOG_NAME = "supervisor_live.log"
DEFAULT_LATEST_JOB_JSON = PART5_DIR / "agent_runs" / "crypto_company_longrun_latest.json"

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manage part5 round runtime: launch queues, attempt isolation, and policy-driven recovery.",
    )
...
def build_spawn_prompt(row: dict[str, str], model: str, reasoning: str, launch_reason: str, attempt_mode: str) -> str:
    ...
    return (
        f"Use a fresh worker subagent for exactly one part5 batch attempt, then exit. Recommended model: {model}, reasoning {reasoning}.\n\n"
